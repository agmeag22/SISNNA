...
//                            console.log(value);
    ...
    <jsp:body>
        ${respuesta}
        <form action="${pageContext.request.contextPath}/deptos/guardar" method = "post" class="country">
            <div class="container1">
                <div class="container-grid-flex">
                     ${respuesta}
                    <div class="card mb-4 user_info_container">
                        <div class="card-header">
                            AÑADIR ESTADOS/REGIONES A UN PAÍSES
                        </div>
                        <div class="card-body card-body2">
                            ...
                            <!--A'adir estadp-->
                            <div class="form-group">
                                Añadir estado al país.
                                <input type="text" class="form-control " name="name" id="inputName" placeholder="Escriba nombre del estado">
                            ...
                            <button type="submit" class="btn btn-warning btn-user button" id='depto'>
                                ...
                                <span class="text">AÑADIR ESTADO</span>
                    ...
                    <div class="card mb-4 account_container">
                        ...
                        <div class="card-body">
                            ...
                            <button type="submit" class="btn btn-warning btn-user button" id='muni'>
                                <span class="icon text-white-50">
                                    <i class="fas fa-edit"></i>
                                </span>
