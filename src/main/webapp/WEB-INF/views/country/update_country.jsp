...
//                            console.log(value);
    ...
    <jsp:body>
        <form action="${pageContext.request.contextPath}/paises/guardar_modificacion_pais/${country.idCountry}" method = "post" class="country">
            <div class="container1">
                    ...
                    <div class="card mb-4 user_info_container">
                        ...
                        <div class="card-body card-body2">
                            <div class="form-group">
                                Nombre
                                <input type="text" class="form-control " name="name" id="inputName" value="${country.name}" required>
                                <small id="nameHelp" class="form-text text-muted">Ingrese nombre del país (Ejemplo: El Salvador).</small>
                            </div>
                            <div class="form-group">
                                Codigo de país
                                <input type="text" class="form-control " name="code" id="inputCode" value="${country.code}" required>
                                <small id="nameHelp" class="form-text text-muted">Ingrese el número de código del país (Ejemplo: Para El Salvador "222").</small>
                            </div>
                                                        
                            <div class="form-group">
                                Codigo ISO 3166a-1
                                <input type="text" class="form-control " name="iso3166a1" id="inputIso3166a1" value="${country.iso3166a1}" required>
                                <small id="nameHelp" class="form-text text-muted">Ingrese ISO 3166a-1 (Ejemplo: Para El Salvador "SV").</small>
                            </div>
                            
                            <div class="form-group">
                                Codigo ISO 3166a-2
                                <input type="text" class="form-control " name="iso3166a2" id="inputIso3166a2" value="${country.iso3166a2}" required>
                ...
                <button type="submit" class="btn btn-warning btn-user button">
                    ...
                    <span class="text">MODIFICAR PAÍS</span>
